...
/// <summary>
/// 필터 배경색 컨버터 (선택됨: 반투명 배경, 미선택: 투명)
/// </summary>
public class BoolToFilterBgConverter : IValueConverter
{
...
/// <summary>
/// 필터 전경색 컨버터 (선택됨: 밝은색, 미선택: 회색)
/// </summary>
public class BoolToFilterFgConverter : IValueConverter
{
